...
//        Assert.assertEquals(elementosOrdenados, quickSort.ordernar(elementosDesordenados, 0, elementosDesordenados.length-1));
//    }
//
//    @Test
//    public void mergeSort(){
//        int[] vetorAuxiliar = new int[elementosDesordenados.length];
//        Assert.assertEquals(elementosOrdenados, mergeSort.ordernar(elementosDesordenados, vetorAuxiliar, 0, elementosDesordenados.length -1));
//    }
//}
